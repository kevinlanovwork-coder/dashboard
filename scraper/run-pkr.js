...
async function scrapeGme(browser) {
  ...
  try {
    ...
    await page.fill('#CountryValue', 'Pakistan'); await page.waitForTimeout(300);
    await page.click('#toCurrUl li[data-countrycode="PKR"]');
...
async function scrapeSentbe(browser) {
  ...
  try {
    ...
    await page.click('.receiveAmountInput .el-select-dropdown__item:has-text("파키스탄")');
    await page.waitForTimeout(1000);
