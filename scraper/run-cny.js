...
async function scrapeGmoneytransApi(paymentType, deliveryMethodName) {
  ...
  const serviceCharge = parseField(text, 'serviceCharge') ?? 4000;
...
const SCRAPERS = [
  ...
  { name: 'WireBarley',  fn: (b) => withRetry(() => scrapeWirebarley(b, { koreanName: '중국', country: COUNTRY, amount: AMOUNT, deliveryMethod: 'Alipay' })), needsBrowser: true  },
